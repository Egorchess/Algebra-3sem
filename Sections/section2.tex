...
\begin{proof}
    ...
    $\\$\textit{Я устал пытаться починить доказательство, которое было здесь ранее, поэтому теперь оно в корне изменено - данный вариант взят из материалов \href{https://halgebra.math.msu.su/staff/klyachko/lect21.pdf}{спецкурса} А.А. Клячко и кажется мне значительно более наглядным.}\\

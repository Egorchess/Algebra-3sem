...
\end{subtheorem}
\begin{proof}
    $\\\Longrightarrow: \ $ Пусть $G/N$ абелева. Тогда $\forall g_1, g_2 \in G: \ (g_1N)(g_2N) = (g_2N)(g_1N) \Longrightarrow g_1g_2N = g_2g_1N \Longrightarrow g_1^{-1}g_2^{-1}g_1g_2 = [g_1^{-1}, g_2^{-1}] \in N$. Значит, любой коммутатор $\in N$, а значит и все произведения коммутаторов $\in N$, то есть $G' \subseteq N$.

...
\begin{proof}
    ...
    Пусть $N$ не нормальна в $S_n$. Обозначим $N_1 = N, N_2 = (12)N_1(12)$. Если $N_1 = N_2$, то $N$ при сопряжении любой $\sigma \in S_n$ не изменится, т.е. $N \unlhd S_n$ - противоречие. Поэтому $N_1 \neq N_2$, причём $|N_1| = |N_2|$.\\
    ...
    \end{enumerate}
    Теперь индукцией по $n \leq 5$ докажем, что $A_n$ - простая.\\

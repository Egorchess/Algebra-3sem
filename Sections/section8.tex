...
\begin{definition}
    ...
    \[G = G_0 \geq G_1 \geq ... \geq G_m = \{e\}; \ \ G_{i+1} \unlhd G_i \ (i = \overline{0....m-1})\]
\end{definition}
\begin{example}
    $G = A_4, H = V_4, K = \langle (12)(34) \rangle$. Тогда $H \unlhd G$, $K \unlhd H$, то есть $G \geq H \geq K \geq \{\textup{id}\}$ --- субнормальная матрёшка.
\end{example}
\begin{theorem}
    Группа $G$ разрешима $\Longleftrightarrow G$ обладает субнормальной матрёшкой такой, что $G_i/G_{i+1}$ --- абелева $(i = \overline{0....m-1})$. 
\end{theorem}
\begin{proof}
    Без доказательства.
\end{proof}

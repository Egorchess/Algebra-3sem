...
\begin{document}
  ...
  \import{Sections/}{endpage.tex}
    
\begin{thebibliography}{}
  \bibitem{klyachko}  ``Спецкурс по теории групп'', Клячко А.А., 2022, \url{https://halgebra.math.msu.su/staff/klyachko/lect21.pdf}
  \bibitem{linal} ``Линейная алгебра, 2 семестр, 2 поток, лектор Чубаров И.А.'', команда 108 группы, 2025, \url{https://github.com/Viacheslavik122333/Linear-algebra/blob/main/linal.pdf}
  \bibitem{algebra} ``Алгебра, 1 семестр, 2 поток, лектор Куликова О.В.'', команда 108 группы, 2024, \url{https://github.com/Viacheslavik122333/Halgebra1sem/blob/main/lecture.pdf}
  \bibitem{bunina} ``Лекции по высшей алгебре, 2 курс, 1 поток'', Бунина Е.И., 2016, \url{https://halgebra.math.msu.su/wiki/doku.php/staff:bunina}
\end{thebibliography}
\end{document}
